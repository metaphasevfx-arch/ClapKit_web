(function () {
  ...
  const ui = {
    ru: {
      ...
      successRemote: "Спасибо. Ответ получен и сохранён.",
      successLocal: "Спасибо. Ответ сохранён локально в этом браузере (тестовый режим).",
      successFallback: "Сеть недоступна: ответ сохранён локально в этом браузере.",
    ...
    en: {
      ...
      successRemote: "Thank you. Your response has been saved.",
      successLocal: "Thanks. Your response is saved locally in this browser (test mode).",
      successFallback: "Network failed: your response is saved locally in this browser.",
